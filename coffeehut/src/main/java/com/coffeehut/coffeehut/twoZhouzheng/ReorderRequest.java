...
/**
 * Request payload for placing a reorder based on a previous order.
 * <p>
 * Carries the customer details, desired pickup time, total price, and
 * the list of items to be reordered. Populated by the frontend from a
 * previously completed order and submitted to the reorder endpoint.
 * </p>
 * <p>
 * This class is a plain data-transfer object with no validation logic;
 * all validation is performed by the service layer that consumes it.
 * </p>
 */
public class ReorderRequest {
     ...
     * <p>
     * If {@code null}, the service layer defaults the pickup time to
     * 10 minutes from the moment the reorder is created.
     * </p>
     */
     ...
     * stores this value directly without recalculating from item prices.
     * </p>
     */
     ...
     * customisations from the original order. May be {@code null} if the
     * frontend omits the field, in which case no items are saved.
     * </p>
     */
     ...
     * <p>
     * When {@code null}, the service layer will default the pickup time
     * to 10 minutes after the reorder is created.
     * </p>
     *
     ...
     *
     * @return the list of {@link OrderItem} entries, or {@code null} if
     ...
     *
     * @param items the list of {@link OrderItem} entries copied from the
     *              original order; may be {@code null}
     */
